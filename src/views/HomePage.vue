        ...
        <a-row :gutter="8" class="count-info">
            ...
            <a-col :span="12" class="project-wrapper">
                <a-card title="进行中的项目" class="project-card">
                    <a href="https://github.com/yuan1?tab=repositories" target="_blank" slot="extra">所有项目</a>
                    <table>
                        <tr>
                            <td>
        ...
        data() {
            return {
                ...
                projects: [
                    ...
                    {
                        name: 'Admin-Shiro-Vue',
                        des: 'Admin-Shiro前后端分离版本，前端架构采用Vue全家桶。',
                        avatar: 'F'
                    },
                    {
                        name: 'Admin-Actuator',
                        des: '使用Spring Boot Admin 2.0.2构建，Admin。',
                        avatar: 'F'
                    }
                ],
                todayIp: '',
